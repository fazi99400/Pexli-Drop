...
// global maxInstances:4 — swap + send-PEX verification both go through this,
// so it's the other high-traffic on-chain path) — 6 × 80 = 480 concurrent.
const verifyTxHash = onCall({ ...CALL_OPTS, cpu: 1, concurrency: 80, maxInstances: 6 }, async (request) => {
